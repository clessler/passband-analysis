...
def plot_colored_hist(data, bins, snr_values, n_rms_iters=7, rms_threshold=5,
    ...
    plt.colorbar(matplotlib.cm.ScalarMappable(norm, cmap=cmap), ax=plt.gca(), 
...
def find_interferograms_clean(data, fourier_band_filters, fourier_noise_filter,
                              take_sqrt_of_data=False,
                              divide_by_nonmax_of_data=False):
    '''get initial cut stats for all the bands. nonmax'''
